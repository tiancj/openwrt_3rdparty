...
io.output(json_file)
io.write("{\"log\":{\"loglevel\":\"warning\",\"access\":\"\",\"error\":\"\"},\"dns\": {\"servers\": [\"localhost\"]},\"inbounds\":[{\"port\":7070,\"tag\": \"listen\",\"protocol\":\"dokodemo-door\",\"address\":\"\",\"settings\":{\"followRedirect\":true,\"network\":\"tcp,udp\",\"timeout\":50},\"domainOverride\":[\"tls\",\"http\"]},{\"listen\":\"0.0.0.0\",\"port\":1081,\"protocol\":\"socks\",\"tag\":\"socksinbound\",\"settings\":{\"auth\":\"noauth\",\"udp\":false,\"ip\":\"0.0.0.0\"}},{\"listen\":\"0.0.0.0\",\"port\":1082,\"protocol\":\"http\",\"tag\":\"httpinbound\",\"settings\":{\"timeout\":0}}],")
